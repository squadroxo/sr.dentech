      ...
      <div className={style.containerGeral}>
        ...
        >
          ...
          <p className={style.textoSobre}>
            ...
            todas as famílias. Nossa missão é proporcionar educação de qualidade
            e cuidados odontológicos de primeira, tudo para garantir mais
            qualidade de vida e muitos sorrisos felizes.
          </p>
        </motion.div>
          ...
          <div className={style.objetivo}>
            <div className={style.missao}>
              ...
              <p>
                ...
                através da educação, prevenção e acesso a cuidados odontológicos
                excepcionais.
              </p>
            </div>
            <div className={style.visao}>
              ...
              <p>
                ...
                comunitária, criando sorrisos saudáveis e contagiando felicidade
            ...
            <div className={style.valores}>
              ...
              <ul>
                <li>
                  Compromisso: Estamos 100% dedicados e responsáveis em tudo que
                  fazemos.
                </li>
                <li>
